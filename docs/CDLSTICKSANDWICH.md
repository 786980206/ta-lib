...
## Overview
The S T I C K S A N D W I C H pattern is a candlestick pattern that provides signals for market direction and potential reversals.

## Category
Pattern Recognition

## Calculation
The CDLSTICKSANDWICH function identifies s t i c k s a n d w i c h patterns based on specific candlestick formations.
