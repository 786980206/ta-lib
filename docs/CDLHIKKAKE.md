...
## Overview
The H I K K A K E pattern is a candlestick pattern that provides signals for market direction and potential reversals.

## Category
Pattern Recognition

## Calculation
The CDLHIKKAKE function identifies h i k k a k e patterns based on specific candlestick formations.
