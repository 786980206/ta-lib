...
## Overview
The K I C K I N G B Y L E N G T H pattern is a candlestick pattern that provides signals for market direction and potential reversals.

## Category
Pattern Recognition

## Calculation
The CDLKICKINGBYLENGTH function identifies k i c k i n g b y l e n g t h patterns based on specific candlestick formations.
