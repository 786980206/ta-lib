...
### Three Line Strike Criteria
- First three candles are in the same direction
- Fourth candle reverses the trend
- Fourth candle engulfs the previous three candles
