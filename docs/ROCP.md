...
ROCP is calculated as the percentage change in price over a period:

### Formula
```
ROCP = ((Current Price - Price n periods ago) / Price n periods ago) × 100
```
