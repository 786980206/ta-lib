# CDLGRAVESTONEDOJI - 墓碑十字星形态

## 概述
墓碑十字星形态（CDLGRAVESTONEDOJI）是一种K线形态，由一根在区间底部有小实体和长上影线的蜡烛组成。这是一个看跌反转形态，可以预示趋势变化。

## 分类
形态识别

## 计算方法
CDLGRAVESTONEDOJI 函数通过分析蜡烛的实体和影线特征来识别墓碑十字星形态：
