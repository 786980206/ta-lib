# CDLKICKINGBYLENGTH - 长度踢脚形态

## 概述
长度踢脚形态是一种强反转形态，由两根相反颜色的光头光脚K线组成，第二根更长。

## 分类
形态识别

## 计算方法
CDLKICKINGBYLENGTH 函数识别长度踢脚形态：

### 看涨长度踢脚判断标准
- 第一根K线：黑（看跌）光头光脚
- 第二根K线：白（看涨）光头光脚，比第一根更长，向上跳空

### 看跌长度踢脚判断标准
- 第一根K线：白（看涨）光头光脚
- 第二根K线：黑（看跌）光头光脚，比第一根更长，向下跳空
