...
## 概述
上升下降三法是一种延续形态，显示趋势延续前的短暂整理。

## 分类
形态识别

## 计算方法
CDLRISEFALL3METHODS 函数识别上升下降三法形态：

### 上升三法（看涨）判断标准
- 第一根蜡烛：长白（看涨）蜡烛
- 下一组：在第一根蜡烛范围内保持的小下跌实体（通常为黑色）
- 最后一根蜡烛：收盘价高于第一根蜡烛收盘价的白蜡烛

### 下降三法（看跌）判断标准
- 第一根蜡烛：长黑（看跌）蜡烛
- 下一组：在第一根蜡烛范围内保持的小上升实体（通常为白色）
- 最后一根蜡烛：收盘价低于第一根蜡烛收盘价的黑蜡烛
