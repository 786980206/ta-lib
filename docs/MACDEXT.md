...
- **Fast Period**: Period for fast MA (default: 12)
- **Fast MA Type**: Type of MA for fast line
- **Slow Period**: Period for slow MA (default: 26)
- **Slow MA Type**: Type of MA for slow line
- **Signal Period**: Period for signal line (default: 9)
- **Signal MA Type**: Type of MA for signal line
