...
## Overview
The G A P S I D E S I D E W H I T E pattern is a candlestick pattern that provides signals for market direction and potential reversals.

## Category
Pattern Recognition

## Calculation
The CDLGAPSIDESIDEWHITE function identifies g a p s i d e s i d e w h i t e patterns based on specific candlestick formations.
