...
## Parameters
- **Input**: Price data (typically close prices or any price series)
- **Time Period**: Number of periods to look back (default: 30)
- **Output**: Two integer arrays - minimum index and maximum index
