...
## Overview
The R I S E F A L L3 M E T H O D S pattern is a candlestick pattern that provides signals for market direction and potential reversals.

## Category
Pattern Recognition

## Calculation
The CDLRISEFALL3METHODS function identifies r i s e f a l l3 m e t h o d s patterns based on specific candlestick formations.
