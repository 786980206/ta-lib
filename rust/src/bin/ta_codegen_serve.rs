...
use ta_lib::{Compatibility, Core, FuncUnstId, RetCode, TaFloat};
...
fn handle_request(core: &mut Core, line: &str) -> String {
    ...
    match method {
        "TA_ACCBANDS" => {
            ...
            let out_size = if endIdx >= startIdx {
                endIdx - startIdx + 1
            } else {
                0
            };
        ...
        "TA_SAREXT" => {
            ...
            let optInOffsetOnReverse =
                params["optInOffsetOnReverse"].as_f64().unwrap_or(0.0) as f64;
            let optInAccelerationInitLong =
                params["optInAccelerationInitLong"].as_f64().unwrap_or(0.02) as f64;
            let optInAccelerationLong =
                params["optInAccelerationLong"].as_f64().unwrap_or(0.02) as f64;
            let optInAccelerationMaxLong =
                params["optInAccelerationMaxLong"].as_f64().unwrap_or(0.2) as f64;
            let optInAccelerationInitShort = params["optInAccelerationInitShort"]
                .as_f64()
                .unwrap_or(0.02) as f64;
            let optInAccelerationShort =
                params["optInAccelerationShort"].as_f64().unwrap_or(0.02) as f64;
            let optInAccelerationMaxShort =
                params["optInAccelerationMaxShort"].as_f64().unwrap_or(0.2) as f64;
            let out_size = if endIdx >= startIdx {
                endIdx - startIdx + 1
            } else {
                0
