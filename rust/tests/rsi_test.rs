...
fn test_rsi_basic() {
    ...
    let input: Vec<f64> = vec![
        44.0, 44.34, 44.09, 43.61, 44.33, 44.83, 44.32, 44.55, 43.93, 44.05, 43.80, 43.64, 43.82,
        44.29, 44.09, 44.15, 43.61, 44.33, 44.83, 44.32, 44.55, 43.93, 44.05, 43.80, 43.64, 43.82,
        44.29, 44.09, 44.15, 43.61,
    ];
