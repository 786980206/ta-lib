...
* [f3bf054](https://github.com/TA-Lib/ta-lib/commit/f3bf0542) Scaffolded `ta_codegen/generator/` Rust crate + `ta_codegen/input/mult/` with YAML metadata and logic pseudocode
