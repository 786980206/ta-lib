/* Generated */
                                    ...
                                    int outInteger[] )
   {
      ...
      do {
         ...
         double avg_1 = (((Equal_avgPeriod!=0)) ? ((EqualPeriodTotal/Equal_avgPeriod)) : (ta_candlerange(Equal_rangeType, inOpen[(i-2)], inHigh[(i-2)], inLow[(i-2)], inClose[(i-2)])));
         double divisor_1 = (((Equal_rangeType==2)) ? (2.0) : (1.0));
         _candleaverage_1 = ((Equal_factor*avg_1)/divisor_1);
         double _candleaverage_2;
         double avg_2 = (((Equal_avgPeriod!=0)) ? ((EqualPeriodTotal/Equal_avgPeriod)) : (ta_candlerange(Equal_rangeType, inOpen[(i-2)], inHigh[(i-2)], inLow[(i-2)], inClose[(i-2)])));
         ...
         {
         case 0:
            _candlerange_4 = Math.abs((inClose[(EqualTrailingIdx-2)]-inOpen[(EqualTrailingIdx-2)]));
            break;
         case 1:
            _candlerange_4 = (inHigh[(EqualTrailingIdx-2)]-inLow[(EqualTrailingIdx-2)]);
            break;
         case 2:
            _candlerange_4 = ((inHigh[(EqualTrailingIdx-2)]-inLow[(EqualTrailingIdx-2)])-Math.abs((inClose[(EqualTrailingIdx-2)]-inOpen[(EqualTrailingIdx-2)])));
            break;
         default:
            _candlerange_4 = 0.0;
            break;
