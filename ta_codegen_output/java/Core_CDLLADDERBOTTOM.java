/* Generated */
                                   ...
                                   int outInteger[] )
   {
      ...
      do {
         ...
         {
         case 0:
            _candlerange_2 = Math.abs((inClose[(ShadowVeryShortTrailingIdx-1)]-inOpen[(ShadowVeryShortTrailingIdx-1)]));
            break;
         case 1:
            _candlerange_2 = (inHigh[(ShadowVeryShortTrailingIdx-1)]-inLow[(ShadowVeryShortTrailingIdx-1)]);
            break;
         case 2:
            _candlerange_2 = ((inHigh[(ShadowVeryShortTrailingIdx-1)]-inLow[(ShadowVeryShortTrailingIdx-1)])-Math.abs((inClose[(ShadowVeryShortTrailingIdx-1)]-inOpen[(ShadowVeryShortTrailingIdx-1)])));
            break;
         default:
            _candlerange_2 = 0.0;
            break;
