/* Generated */
                                  ...
                                  int outInteger[] )
   {
      ...
      outIdx = 0;
      do {
         if( (((((((Math.abs((inClose[(i-2)]-inOpen[(i-2)]))>ta_candleaverage(BodyLong_rangeType, BodyLong_avgPeriod, BodyLong_factor, BodyLongPeriodTotal, inOpen[(i-2)], inHigh[(i-2)], inLow[(i-2)], inClose[(i-2)]))&&((((inClose[(i-2)]>=inOpen[(i-2)])) ? (1) : ((0-1)))==1))&&(Math.abs((inClose[(i-1)]-inOpen[(i-1)]))<=ta_candleaverage(BodyShort_rangeType, BodyShort_avgPeriod, BodyShort_factor, BodyShortPeriodTotal, inOpen[(i-1)], inHigh[(i-1)], inLow[(i-1)], inClose[(i-1)])))&&(((Math.min(inOpen[(i-1)], inClose[(i-1)])>Math.max(inOpen[(i-2)], inClose[(i-2)]))) ? (1) : (0)))&&(Math.abs((inClose[i]-inOpen[i]))>ta_candleaverage(BodyShort_rangeType, BodyShort_avgPeriod, BodyShort_factor, BodyShortPeriodTotal2, inOpen[i], inHigh[i], inLow[i], inClose[i])))&&((((inClose[i]>=inOpen[i])) ? (1) : ((0-1)))==(0-1)))&&(inClose[i]<(inClose[(i-2)]-(Math.abs((inClose[(i-2)]-inOpen[(i-2)]))*optInPenetration)))) ) {
         ...
         {
         case 0:
            _candlerange_6 = Math.abs((inClose[BodyShortTrailingIdx]-inOpen[BodyShortTrailingIdx]));
            break;
         case 1:
            _candlerange_6 = (inHigh[BodyShortTrailingIdx]-inLow[BodyShortTrailingIdx]);
            break;
         case 2:
            _candlerange_6 = ((inHigh[BodyShortTrailingIdx]-inLow[BodyShortTrailingIdx])-Math.abs((inClose[BodyShortTrailingIdx]-inOpen[BodyShortTrailingIdx])));
            break;
         default:
            _candlerange_6 = 0.0;
            break;
         ...
         {
         case 0:
            _candlerange_8 = Math.abs((inClose[(BodyShortTrailingIdx+1)]-inOpen[(BodyShortTrailingIdx+1)]));
            break;
         case 1:
            _candlerange_8 = (inHigh[(BodyShortTrailingIdx+1)]-inLow[(BodyShortTrailingIdx+1)]);
            break;
         case 2:
            _candlerange_8 = ((inHigh[(BodyShortTrailingIdx+1)]-inLow[(BodyShortTrailingIdx+1)])-Math.abs((inClose[(BodyShortTrailingIdx+1)]-inOpen[(BodyShortTrailingIdx+1)])));
            break;
         default:
            _candlerange_8 = 0.0;
            break;
