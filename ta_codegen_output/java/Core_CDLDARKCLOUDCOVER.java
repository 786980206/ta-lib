/* Generated */
                                     ...
                                     int outInteger[] )
   {
      ...
      do {
         ...
         double avg_1 = (((BodyLong_avgPeriod!=0)) ? ((BodyLongPeriodTotal/BodyLong_avgPeriod)) : (ta_candlerange(BodyLong_rangeType, inOpen[(i-1)], inHigh[(i-1)], inLow[(i-1)], inClose[(i-1)])));
         double divisor_1 = (((BodyLong_rangeType==2)) ? (2.0) : (1.0));
         _candleaverage_1 = ((BodyLong_factor*avg_1)/divisor_1);
         if( (((((((((inClose[(i-1)]>=inOpen[(i-1)])) ? (1) : ((0-1)))==1)&&(Math.abs((inClose[(i-1)]-inOpen[(i-1)]))>_candleaverage_1))&&((((inClose[i]>=inOpen[i])) ? (1) : ((0-1)))==(0-1)))&&(inOpen[i]>inHigh[(i-1)]))&&(inClose[i]>inOpen[(i-1)]))&&(inClose[i]<(inClose[(i-1)]-(Math.abs((inClose[(i-1)]-inOpen[(i-1)]))*optInPenetration)))) ) {
         ...
         {
         case 0:
            _candlerange_3 = Math.abs((inClose[(BodyLongTrailingIdx-1)]-inOpen[(BodyLongTrailingIdx-1)]));
            break;
         case 1:
            _candlerange_3 = (inHigh[(BodyLongTrailingIdx-1)]-inLow[(BodyLongTrailingIdx-1)]);
            break;
         case 2:
            _candlerange_3 = ((inHigh[(BodyLongTrailingIdx-1)]-inLow[(BodyLongTrailingIdx-1)])-Math.abs((inClose[(BodyLongTrailingIdx-1)]-inOpen[(BodyLongTrailingIdx-1)])));
            break;
         default:
            _candlerange_3 = 0.0;
            break;
