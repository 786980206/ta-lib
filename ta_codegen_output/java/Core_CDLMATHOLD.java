/* Generated */
                              ...
                              int outInteger[] )
   {
      ...
      do {
         ...
         {
         case 0:
            _candlerange_12 = Math.abs((inClose[(i-4)]-inOpen[(i-4)]));
            break;
         case 1:
            _candlerange_12 = (inHigh[(i-4)]-inLow[(i-4)]);
            break;
         case 2:
            _candlerange_12 = ((inHigh[(i-4)]-inLow[(i-4)])-Math.abs((inClose[(i-4)]-inOpen[(i-4)])));
            break;
         default:
            _candlerange_12 = 0.0;
            break;
         ...
         {
         case 0:
            _candlerange_13 = Math.abs((inClose[(BodyLongTrailingIdx-4)]-inOpen[(BodyLongTrailingIdx-4)]));
            break;
         case 1:
            _candlerange_13 = (inHigh[(BodyLongTrailingIdx-4)]-inLow[(BodyLongTrailingIdx-4)]);
            break;
         case 2:
            _candlerange_13 = ((inHigh[(BodyLongTrailingIdx-4)]-inLow[(BodyLongTrailingIdx-4)])-Math.abs((inClose[(BodyLongTrailingIdx-4)]-inOpen[(BodyLongTrailingIdx-4)])));
            break;
         default:
            _candlerange_13 = 0.0;
            break;
         ...
         for( totIdx = 3; (totIdx>=1); totIdx -= 1 ) {
            ...
            {
            case 0:
               _candlerange_15 = Math.abs((inClose[(BodyShortTrailingIdx-totIdx)]-inOpen[(BodyShortTrailingIdx-totIdx)]));
               break;
            case 1:
               _candlerange_15 = (inHigh[(BodyShortTrailingIdx-totIdx)]-inLow[(BodyShortTrailingIdx-totIdx)]);
               break;
            case 2:
               _candlerange_15 = ((inHigh[(BodyShortTrailingIdx-totIdx)]-inLow[(BodyShortTrailingIdx-totIdx)])-Math.abs((inClose[(BodyShortTrailingIdx-totIdx)]-inOpen[(BodyShortTrailingIdx-totIdx)])));
               break;
            default:
               _candlerange_15 = 0.0;
               break;
