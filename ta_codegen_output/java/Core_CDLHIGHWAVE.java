/* Generated */
                               ...
                               int outInteger[] )
   {
      ...
      do {
         ...
         double avg_2 = (((BodyShort_avgPeriod!=0)) ? ((BodyPeriodTotal/BodyShort_avgPeriod)) : (ta_candlerange(BodyShort_rangeType, inOpen[i], inHigh[i], inLow[i], inClose[i])));
         double divisor_2 = (((BodyShort_rangeType==2)) ? (2.0) : (1.0));
         _candleaverage_2 = ((BodyShort_factor*avg_2)/divisor_2);
         double _candleaverage_3;
         double avg_3 = (((ShadowVeryLong_avgPeriod!=0)) ? ((ShadowPeriodTotal/ShadowVeryLong_avgPeriod)) : (ta_candlerange(ShadowVeryLong_rangeType, inOpen[i], inHigh[i], inLow[i], inClose[i])));
         ...
         double avg_4 = (((ShadowVeryLong_avgPeriod!=0)) ? ((ShadowPeriodTotal/ShadowVeryLong_avgPeriod)) : (ta_candlerange(ShadowVeryLong_rangeType, inOpen[i], inHigh[i], inLow[i], inClose[i])));
